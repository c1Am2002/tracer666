...
def statistics_project_user(request, project_id):
    ...
    all_user_dict[request.tracer.project.create_name.id] = {
        'name': request.tracer.project.create_name.name,
    ...
    user_list = models.project_people.objects.filter(project_id_id=project_id)
